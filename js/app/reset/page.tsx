...
function ResetContent() {
  ...
  async function submit() {
    ...
    try {
      ...
      if (!res.ok) {
        setErr(data?.error || "Zuruecksetzen fehlgeschlagen.");
      } else {
        setMsg("Passwort aktualisiert. Sie koennen sich jetzt anmelden.");
  ...
  return (
    <main className="max-w-md mx-auto p-6 space-y-4">
      <h1 className="text-2xl font-semibold">Passwort zuruecksetzen</h1>
